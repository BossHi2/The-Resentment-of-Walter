...
public class MainCharacter : MonoBehaviour
{
    ...
    public bool hasUserClicked = false;
    ...
    public TextMeshProUGUI safeInputText;
    public TextMeshProUGUI exitInputText;
    ...
    void FixedUpdate()
    {
        ...
        {
            scrollUI.SetActive(false);
            safeInputText.text = "Enter Code:";
            safeInputUI.SetActive(false);
            exitInputText.text = "Enter Code:";
            exitInputUI.SetActive(false);
        }
    ...
    public void ChangeHealth(int changeAmount){
        if(changeAmount < 0 && (isThrusting == false || isImmune == false)){
        ...
        UIHealthBar.instance.SetValue(health / 5.0f);
        if (health <= 0)
        {
